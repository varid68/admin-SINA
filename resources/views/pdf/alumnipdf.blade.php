  ...
  <head>
    ...
    <body>
      ...
      <div style="font-family:Segoe Print; font-size:15px;font-style:italic">
        ...
        @endif          
        <p style="font-family:Arial; font-size:15px;font-style:italic">Tahun lulus : {{ $start + 2}} ~ {{ $end + 2 }}</p>
      </div>
      <br>
      ...
      <table class="tg">
        <tr>
          ...
          <th class="tg-3wr7">Jurusan/Tahun masuk<br></th>
          <th class="tg-3wr7">Alamat<br></th>
          <th class="tg-3wr7">Judul TA<br></th>
        </tr>
        @php $no = 1; @endphp
        @if (count($response < 1))
          ...
          <tr>
            ...
            <td class="tg-rv4w" width="25%">{{ $item->judul_ta }}</td>
          </tr>
          @endforeach
        @else
          <p style="text-align:center">Tidak ada hasil..</p>
        @endif
      </table><br>
